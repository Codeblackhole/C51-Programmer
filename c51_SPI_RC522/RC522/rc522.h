...
extern char PcdRequest(u8 req_code,u8 *pTagType);
extern void PcdAntennaOn(void);
extern void PcdAntennaOff(void);
extern char M500PcdConfigISOType(u8 type);
extern char PcdAnticoll(u8 *pSnr);
extern char PcdSelect(u8 *pSnr);
extern char PcdAuthState(u8 auth_mode,u8 addr,u8 *pKey,u8 *pSnr);
extern char PcdWrite(u8 addr,u8 *pData);
extern char PcdRead(u8 addr,u8 *pData);
